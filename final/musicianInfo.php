        ...
        <form id="alter" name="alter" method="post" action="musicianAltering.php">
            ...
            $sql = ("SELECT * FROM Artists WHERE ArtistID = $id");
                foreach ($dbh->query($sql) as $row){
                    $Genres = array();
                    $sql2 = ("SELECT Genre FROM genres WHERE artistID = $row[ArtistID]");
                    ...
                    echo "<table><tbody>
                        ...
                        <tr><td align='right'>Image File Path: </td><td><input type='text' name='artistPath' value='$row[ArtistImagePath]' /></td></tr>
                        ...
                        <tr><td align='right'>Genres:<br></td><td><input type='text' name='artistGenres' value='$genreList' /></td></tr>
